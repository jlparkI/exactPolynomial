...
class KernelBaseclass(ABC):
    ...
    Attributes:
        num_feats (int): The number of features the kernel will generate.
    ...
    def __init__(self, num_feats, xdim, num_threads = 2):
        ...
        Args:
            num_feats (int): The number of features that will be generated.
    ...
    def get_num_feats(self):
        """Returns number of features. Not a @property because
